...
export default function ContextMenu({geometry, contextMenu}){
    ...
    return(
            ...
            <div id="contextMenu" className={`py-4 px-3 bg-white  opacity-90 absolute hover:cursor-pointer ${contextMenu.status || 'hidden'}`} style={{top: properties.pageY+'px', left: properties.pageX +'px'}}>
                <ul>
