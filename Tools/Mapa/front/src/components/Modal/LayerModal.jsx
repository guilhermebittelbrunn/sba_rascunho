...
const recomendColors = ['#F5222D','#FA8C16','#FADB14','#8BBB11','#52C41A','#13A8A8','#1677FF','#2F54EB','#722ED1','#EB2F96','#F5222D4D','#FA8C164D','#FADB144D','#8BBB114D','#52C41A4D','#13A8A84D','#1677FF4D','#2F54EB4D','#722ED14D','#EB2F964D']
const svgList = [
                    {
                        type: 'svg',
                        name: false,
                    ...
                    <form className='flex flex-col gap-1' onSubmit={handleSubmit(handleOk)}>
                        ...
                        <div>
                            ...
                            <Controller name='layerName' control={control} render={({field})=>{
                                return (
                                    <Input 
                                        field={field} value={field.value} onChange={(value)=>field.onChange(value)}
                                        placeholder="Título da camada" size='small' className='w-[300px]'
                                    />
                                )
                            }}/>          
                        </div>
